...
void initialize (void)
{
    ...
    cout << "L : switch between using Gouraud or Phong shaders" << endl;
    cout << "M : switch between bunny or plane mesh" << endl;
    cout << "S : save screenshot to PPM" << endl;
    cout << "E : save hand-in cases to PPM" << endl;
    cout << " ***************** " << endl;
}
...
void keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	...
	else if (key == GLFW_KEY_R && action == GLFW_PRESS)
    {
        ...
        widget->toggleShader();
    else if (key == 'M' && action == GLFW_PRESS)
        widget->toggleMesh();
    else if (key == 'E' && action == GLFW_PRESS)
        widget->runHandInCases();
